...
input_path <- "/home/kisa11/work/projects/80K_MPRA/80k_region_enrichment_regioneReloaded" # no tailing slash allowed
output_directory <- "/home/kisa/coding/80K_MPRA/remap_chipseq_pia/80k_results" # no trailing slash allowed
output_directory <- "/home/kisa11/work/projects/80K_MPRA/80k_region_enrichment_regioneReloaded/80k_results" # no trailing slash allowed
n_threads <- 64
# remap2022:
...
around_zero_activity_both_cell_types_001 <- file.path(output_directory, "around_zero_activity_both_cell_types_2_duplicated_regions_not_stand_aware.bed")

# less conservative background sequences
around_zero_activity_both_cell_types_004 <- file.path(output_directory, "around_zero_activity_both_cell_types_2_duplicated_regions_not_stand_aware_Thresh_004.bed")

# NGN2 focus
upbed <- file.path(output_directory, "ngn2_increasing_regions_duplicates_without_considering_strand.bed")
downbed <- file.path(output_directory, "ngn2_decreasing_regions_duplicates_without_considering_strand.bed")
...
output_name <- "ngn2_with_background_full_remap_TF_chip_increasing_decreasing_CrosswiseMatrix.rds"
...
# Plot the data
pdf_name_enhancer <- "dotplot_enhancer_with_background_full_remap2022_TF_enrichment.pdf"
...
# Plot the data
pdf_name_silencer <- "dotplot_silencer_with_background_full_remap2022_TF_enrichment.pdf"
