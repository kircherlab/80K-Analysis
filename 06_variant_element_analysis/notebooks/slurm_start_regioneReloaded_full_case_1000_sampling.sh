...
# Run R script
Rscript /sc-projects/sc-proj-bih-reg-seqs/users/kisa11/projects/80k_region_enrichment_regioneReloaded/regioneReloaded_NGN2_undiffWTC11_based_on_pia_code_performing_analysis_full_case_sampling_1000.R
